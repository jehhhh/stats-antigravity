...
var require_react_katex = __commonJS({
  "node_modules/react-katex/dist/react-katex.js"(exports, module) {
    (function(global, factory) {
      if (typeof module === "object" && typeof module.exports === "object") factory(exports, require_react(), require_prop_types(), require_katex());
      ...
      _katex = _interopRequireDefault(_katex);
      ...
      const createMathComponent = (Component, { displayMode }) => {
        const MathComponent = ({ children, errorColor, math, renderError }) => {
          ...
          if (error) {
            return renderError ? renderError(error) : _react.default.createElement(Component, {
              html: `${error.message}`
            });
          }
...
export default require_react_katex();
